...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <b className="font-bold">Hi, I&apos;m Umair.</b> I am a <b className="font-bold">data scientist</b> with amazing projects and skills. My focus is to solve complex problems using data science approaches.
      </motion.h1>
